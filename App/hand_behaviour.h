...
//extern void gimbal_behaviour_mode_set(Hand_Control_t *gimbal_mode_set);

//extern void gimbal_behaviour_control_set(fp32 *add_yaw, fp32 *add_pitch, Hand_Control_t *gimbal_control_set);
